...
public class TextTest
{
	...
	@Test
	public void testGetEditDistanceMatrix()
	{
		Text.editDistance("interest", "ntvaestes", true);
		int[][] expected = new int[][] {
			new int[] {0, 1, 2, 3, 4, 5, 6, 7, 8},
			new int[] {1, 1, 1, 2, 3, 4, 5, 6, 7},
			new int[] {2, 2, 2, 1, 2, 3, 4, 5, 6},
			new int[] {3, 3, 3, 2, 2, 3, 4, 5, 6},
			new int[] {4, 4, 4, 3, 3, 3, 4, 5, 6},
			new int[] {5, 5, 5, 4, 3, 4, 3, 4, 5},
			new int[] {6, 6, 6, 5, 4, 4, 4, 3, 4},
			new int[] {7, 7, 7, 6, 5, 5, 5, 4, 3},
			new int[] {8, 8, 8, 7, 6, 6, 5, 5, 4},
			new int[] {9, 9, 9, 8, 7, 7, 6, 5, 5}};
			
		assertArrayEquals(expected, Text.getEditDistanceMatrix());
	}
